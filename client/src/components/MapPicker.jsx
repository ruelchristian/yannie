...
const ICCT_CAINTA_COORDS = [14.5802, 121.1218];
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-1.5 flex-wrap pt-1">
        <span className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider mr-1">Quick Points:</span>
        <button
          type="button"
          onClick={() => handlePreset(14.5802, 121.1218, 'ICCT Main Gate')}
        ...
        <button
          type="button"
          onClick={() => handlePreset(14.58045, 121.12192, 'Main Building (Floors 1-4)')}
          className="text-xs bg-slate-100 hover:bg-sky-50 hover:text-sky-700 px-2.5 py-1 rounded-md border border-slate-200 transition-colors"
        >
          Main Building
        </button>
        <button
          type="button"
          onClick={() => handlePreset(14.58012, 121.12165, 'Campus Canteen')}
          className="text-xs bg-slate-100 hover:bg-sky-50 hover:text-sky-700 px-2.5 py-1 rounded-md border border-slate-200 transition-colors"
        >
          Canteen
        </button>
        <button
          type="button"
          onClick={() => handlePreset(14.58031, 121.12210, 'College Library 3rd Flr')}
          className="text-xs bg-slate-100 hover:bg-sky-50 hover:text-sky-700 px-2.5 py-1 rounded-md border border-slate-200 transition-colors"
        >
          Library
        </button>
        <button
          type="button"
          onClick={() => handlePreset(14.57995, 121.12150, 'Gymnasium / Multi-Purpose Court')}
          className="text-xs bg-slate-100 hover:bg-sky-50 hover:text-sky-700 px-2.5 py-1 rounded-md border border-slate-200 transition-colors"
        >
          Gym / Court
        </button>
